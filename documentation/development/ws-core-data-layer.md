...
| `WS_JURISDICTION_TAXONOMY` *(taxonomy field)* | taxonomy | Specific jurisdictions served; `save_terms: 1` || `ws_aorg_services` | taxonomy | `ws_aorg_service` terms; `save_terms: 1` |
