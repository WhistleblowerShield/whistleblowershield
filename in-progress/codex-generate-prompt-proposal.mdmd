...
- New schema blocks for legal record types (`statute`, `common-law`, `citation`, `construction`) rebuilt from ACF definitions.
...
- Scope notes fields.
- Citation/construction quality + statute type controls.
- Exclusion controls:
  - Auto exclusions
  - Manual exclusions
  - Disable exclusions
...
- `plugins/ws-core/includes/acf/acf-jx-constructions.php`
...
- `plugins/ws-core/includes/admin/tools/prompt-generator/pg-blocks-shared.php`
  - Shared static blocks (mission, omission, construction, integrity, output contract).
...
### construction schema coverage (from `acf-jx-constructions.php`)
...
1. Build statute/common-law/citation/construction schema blocks from ACF maps.
