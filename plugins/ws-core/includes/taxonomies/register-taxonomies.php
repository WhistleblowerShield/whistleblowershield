 ...
 * 
 * WS_JURISDICTION_TAXONOMY taxonomy table use canonical table array in matrix-jurisdictions.php.
 *
 ...
 */
    'ws_employment_sector'  => [
        ...
        'terms'                 => [
            ...
            'technology-sector'      => 'Technology Sector Worker',
...
function ws_seed_taxonomy($taxonomy, $terms, $option_label, $version = '1.3.2', $ordered = false)
{
