    ...
    return [
        ...
        'waiver_scope' => [
            ...
            'fields' => [
                ...
                [ 'name' => 'anti_slapp_protection_scope', 'type' => 'select', 'multiple' => 1, 'choices' => [ 'motion-to-strike', 'discovery-stay', 'fee-shift-on-motion', 'full-procedural', 'see-context' ], 'group' => 4, 'sister' => 'anti_slapp_protection_context' ],
                ...
                [ 'name' => 'settlement_restriction_scope', 'type' => 'select', 'multiple' => 1, 'choices' => [ 'amount-only', 'facts', 'full-prohibition', 'agency-notification', 'see-context' ], 'group' => 4, 'sister' => 'settlement_restriction_context' ],
