    ...
    return [
        ...
        'sol' => [
            ...
            'fields' => [
                ...
                [ 'name' => 'filing_notice_required_context', 'type' => 'textarea', 'rows' => 3, 'group' => 4, 'conditional' => [ 'field' => 'legal_recognitions', 'taxonomy' => 'ws_legal_recognition', 'slug' => 'pre-filing-notice-required' ] ],
        ...
        'process_remedies' => [
            ...
            'fields' => [
                ...
                [ 'name' => 'preliminary_reinstatement_rule', 'type' => 'select', 'choices' => [ 'mandatory', 'discretionary', 'has-details' ], 'group' => 4, 'sister' => 'preliminary_reinstatement_context' ],
                [ 'name' => 'preliminary_reinstatement_rule_details', 'type' => 'textarea', 'rows' => 3, 'group' => 4, 'conditional' => [ 'field' => 'preliminary_reinstatement_rule', 'operator' => '==', 'value' => 'has-details' ] ],
                [ 'name' => 'preliminary_reinstatement_phase', 'type' => 'select', 'choices' => [ 'admin-phase', 'full-pendency', 'both' ], 'group' => 4, 'sister' => 'preliminary_reinstatement_context' ],
                [ 'name' => 'preliminary_reinstatement_context', 'type' => 'textarea', 'rows' => 3, 'group' => 4, 'conditional' => [ 'field' => 'legal_recognitions', 'taxonomy' => 'ws_legal_recognition', 'slug' => 'preliminary-reinstatement' ] ],                [ 'name' => 'mixed_motive_remedy_context', 'type' => 'textarea', 'rows' => 3, 'group' => 4, 'conditional' => [ 'field' => 'burden_shifting_framework', 'operator' => '==', 'value' => 'mixed-motive' ] ],
        ...
        'waiver_scope' => [
            'label'  => 'Waiver & Scope',
            'fields' => [
                [ 'name' => 'civil_action_waiver_status', 'type' => 'select', 'choices' => [ 'prohibited', 'permitted-individual-only', 'permitted-collective', 'anti', 'see-context' ], 'group' => 2 ],
                [ 'name' => 'civil_action_waiver_context', 'type' => 'textarea', 'rows' => 3, 'group' => 4, 'conditional' => [ 'field' => 'civil_action_waiver_status', 'operator' => '!=empty' ] ],
                [ 'name' => 'contractual_waiver_status', 'type' => 'select', 'choices' => [ 'void', 'limited', 'enforceable', 'void-public-policy', 'void-as-to-whistleblowing', 'enforceable-with-exceptions', 'see-context' ], 'group' => 4, 'sister' => 'contractual_waiver_context' ],
        ...
        'bop' => [
            ...
            'fields' => [
                ...
                [ 'name' => 'causation_scope', 'type' => 'select', 'choices' => [ 'liability', 'damages', 'both', 'see-context' ], 'group' => 4, 'sister' => 'causation_standard_context' ],
                [ 'name' => 'causation_scope_context', 'type' => 'textarea', 'rows' => 3, 'group' => 4, 'conditional' => [ 'field' => 'causation_scope', 'operator' => '!=empty' ] ],
                ...
                [ 'name' => 'employer_knowledge_context', 'type' => 'textarea', 'rows' => 3, 'group' => 4, 'conditional' => [ 'field' => 'legal_recognitions', 'taxonomy' => 'ws_legal_recognition', 'slug' => 'employer-knowledge-required' ] ],
        ...
        'reward' => [
            ...
            'fields' => [
                ...
                [ 'name' => 'qui_tam_share_context', 'type' => 'textarea', 'rows' => 3, 'group' => 4, 'conditional' => [ 'field' => 'process_types', 'taxonomy' => 'ws_process_type', 'slug' => 'qui-tam-process' ] ],
