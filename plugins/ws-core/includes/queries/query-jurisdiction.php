 ...
 *
 * Transient keys:
 *      ws_id_for_term_{term_id}_   — post ID lookup by taxonomy term ID
...
function ws_get_id_by_code( $jx_code ) {
    ...
    $cache_key = 'ws_id_for_term_' . $term_id . '_';
...
function ws_get_jurisdiction_data( $input = null ) {
    ...
    return [
        ...
        'author' => ws_build_author_array( $post_id ),
...
function ws_get_jx_summary_data( $jx_term_id ) {
    ...
    return [
        ...
        // Record management
        'author'        => ws_build_author_array( $sid ),
    ];
}
    ...
    $fetch = function( $tid, $is_fed ) {
        ...
        foreach ( $q->posts as $statute ) {
            ...
            $rows[] = [
                ...
                'protected_disclosure'       => ws_q_normalize_id_list( get_field( 'ws_jx_statute_protected_disclosures',      $sid ) ),
                ...
                'fee_shifting_rules'      => ws_q_normalize_id_list( get_field( 'ws_jx_statute_fee_shifting_rules',          $sid ) ),
                'remedies'                => ws_q_normalize_id_list( get_field( 'ws_jx_statute_remedies',              $sid ) ),
                'remedy_details'          => get_post_meta( $sid, 'ws_jx_statute_remedy_details', true ),
    ...
    $fetch = function( $tid, $is_fed ) {
        ...
        foreach ( $q->posts as $citation ) {
            ...
            $rows[] = [
                ...
                'types'           => $type_list,
                'protected_disclosure' => ws_q_normalize_id_list( get_field( 'ws_jx_citation_protected_disclosures', $cid ) ),
                ...
                'remedy_details' => get_post_meta( $cid, 'ws_jx_citation_remedy_details', true ),
                ...
                // Record management
                'author' => ws_build_author_array( $cid ),
            ];
        }
        return $rows;
    };
    ...
    $fetch = function( $tid, $is_fed ) {
        ...
        foreach ( $q->posts as $construct ) {
            ...
            $rows[] = [
                ...
                'protected_disclosure' => ws_q_normalize_id_list( get_field( 'ws_jx_construction_protected_disclosures', $iid ) ),
                ...
                'adverse_action' => ws_q_normalize_id_list( get_field( 'ws_jx_construction_adverse_actions', $iid ) ),
                'adverse_action_details' => get_post_meta( $iid, 'ws_jx_construction_adverse_action_details', true ),
                ...
                'remedy_details' => get_post_meta( $iid, 'ws_jx_construction_remedy_details', true ),
                ...
                // Record management
                'author' => ws_build_author_array( $iid ),
            ];
        }
        return $rows;
    };
...
add_action( 'save_post_jurisdiction', function( $post_id ) {
    ...
    if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) {
        ...
        delete_transient( 'ws_id_for_term_' . $terms[0]->term_id . '_' );
    ...
    $fetch = function( $tid, $is_fed ) {
        ...
        foreach ( $q->posts as $record ) {
            ...
            $rows[] = [
                ...
                'protected_disclosure'       => ws_q_normalize_id_list( get_field( 'ws_jx_comlaw_protected_disclosures',      $rid ) ),
                ...
                'fee_shifting_rules'      => ws_q_normalize_id_list( get_field( 'ws_jx_comlaw_fee_shifting_rules',     $rid ) ),
                'remedies'                => ws_q_normalize_id_list( get_field( 'ws_jx_comlaw_remedies',         $rid ) ),
                'remedy_details'          => get_post_meta( $rid, 'ws_jx_comlaw_remedy_details', true ),
                ...
                'author'  => ws_build_author_array( $rid ),
            ];
        }
        return $rows;
    };
