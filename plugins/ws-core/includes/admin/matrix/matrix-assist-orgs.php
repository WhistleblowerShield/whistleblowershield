...
$_ws_assist_org_matrix = [
    ...
    [
        ...
        'phones' => [
            [ 'type' => 'headquarters', 'number' => '(202) 347-1122', 'url' => 'https://www.pogo.org/contact-us' ],
            [ 'type' => 'secure', 'number' => '1-202-658-5828', 'url' => 'https://www.pogo.org/investigates/send-us-a-tip' ],
        ],
        'emails' => [
            [ 'type' => 'general', 'address' => 'info@pogo.org', 'url' => 'https://www.pogo.org/contact-us' ],
            [ 'type' => 'secure', 'address' => 'pogotips@proton.me', 'url' => 'https://www.pogo.org/investigates/send-us-a-tip' ],
        ],
        'secure_channel' => 1,
        'secure_channels' => [
            [
                'tool' => 'signal',
                'url' => 'https://www.pogo.org/investigates/send-us-a-tip',
                'label' => 'Signal tip contact instructions',
                'class' => 'tip-drop',
            ],
            [
                'tool' => 'protonmail',
                'url' => 'https://www.pogo.org/investigates/send-us-a-tip',
                'label' => 'Proton Mail tip instructions',
                'class' => 'tip-drop',
            ],
            [
                'tool' => 'other',
                'url' => 'https://www.pogo.org/investigates/send-us-a-tip',
                'label' => 'OnionShare document-transfer instructions',
                'class' => 'tip-drop',
            ],
        ],
    ...
    [
        ...
        'contact_url' => '',
        'phones' => [
            [ 'type' => 'headquarters', 'number' => '(202) 296-4826', 'url' => 'https://member.taf.org/become-a-member' ],
        ],
        'emails' => [
            [ 'type' => 'general', 'address' => 'digital@taf.org', 'url' => 'https://member.taf.org/become-a-member' ],
        ],
        'secure_channel' => 0,
        'secure_channels' => [],
    ...
    [
        ...
        'phones' => [],
        'emails' => [
            [ 'type' => 'general', 'address' => 'info@whistleblowingnetwork.org', 'url' => 'https://whistleblowingnetwork.org/About' ],
        ],
        'secure_channel' => 0,
        'secure_channels' => [],
    ...
    [
        ...
        'phones' => [
            [ 'type' => 'headquarters', 'number' => '(202) 452-0620', 'url' => 'https://www.nlada.org/' ],
        ],
        'emails' => [],
        'secure_channel' => 0,
        'secure_channels' => [],
...
function ws_seed_assist_org_matrix() {
    ...
    foreach ( $_ws_assist_org_matrix as $org ) {
        ...
        update_post_meta(
            $post_id,
            'ws_aorg_secure_contact_tools',
            array_values( array_unique( array_column( $org['secure_channels'], 'tool' ) ) )
        );
