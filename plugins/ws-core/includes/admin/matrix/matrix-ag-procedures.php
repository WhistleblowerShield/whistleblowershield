 ...
 * intake path. Each record links to its parent agency via ws_ag_procedure_agency_id,
 ...
 * text and verify intake URLs regularly — see ws_ag_procedure_last_reviewed.
 *
 * SEEDER RULES
 * ------------
 * - All seeded records receive ws_matrix_source = 'matrix-ag-procedures'.
 ...
 * EPA-specific environmental statutes) have ws_ag_procedure_statute_ids left empty.
 ...
 * the walkthrough text describes the variance. ws_ag_procedure_deadline_days is the
 ...
 * 3.10.0 ws_ag_procedure_type removed from scalar meta write. Procedure type now
 *        assigned via wp_set_object_terms( 'ws_procedure_type' ). Data array
 *        key ws_ag_procedure_type retained as the slug source — resolved to a taxonomy
...
$_ws_ag_procedure_matrix = [
    ...
    [
        ...
        'ws_ag_procedure_type'        => 'disclosure',
        'disclosure_types'    => [ 'securities-commodities-fraud' ],
        'ws_ag_procedure_entry_point' => 'online',
        'ws_ag_procedure_intake_url'  => 'https://www.sec.gov/tcr',
        ...
        // award is paid.
        'ws_ag_procedure_identity_policy'   => 'anonymous',
        'ws_ag_procedure_intake_only'       => false,
        'ws_ag_procedure_deadline_days'     => 0,
        'ws_ag_procedure_deadline_clock_start' => '',
        'ws_ag_procedure_has_prerequisites'     => false,
        'ws_ag_procedure_prerequisites_details'=> '',
        'statute_slugs'             => [ 'dodd-frank-section-922' ],
        'ws_ag_procedure_walkthrough_wysiwyg'       => '<ol>
...
<li><strong>File an award application when applicable.</strong> If the SEC brings an enforcement action resulting in sanctions exceeding $1 million and you believe your tip contributed, submit Form WB-APP to the SEC Whistleblower Office to claim your award (10–30% of collected sanctions).</li>
    ...
    [
        ...
        'ws_ag_procedure_type'        => 'retaliation',
        'disclosure_types'    => [ 'retaliation-protection', 'occupational-health-safety', 'securities-commodities-fraud' ],
        'ws_ag_procedure_entry_point' => 'online',
        'ws_ag_procedure_intake_url'  => 'https://www.osha.gov/workers/file-a-complaint',
        'ws_ag_procedure_identity_policy'      => 'identified',
        'ws_ag_procedure_intake_only'          => false,
        ...
        'ws_ag_procedure_deadline_days'        => 30,
        'ws_ag_procedure_deadline_clock_start' => 'adverse_action',
        'ws_ag_procedure_has_prerequisites'        => false,
        'ws_ag_procedure_prerequisites_details'   => '',
...
<li><strong>If OSHA takes no action within 180 days.</strong> Under several statutes (notably SOX and AIR21), you may file a new action in federal district court if OSHA has not issued a final order within 180 days of your complaint. Consult an attorney to evaluate whether to proceed administratively or judicially.</li>
    ...
    [
        ...
        'ws_ag_procedure_entry_point' => 'online',
        'ws_ag_procedure_intake_url'  => 'https://osc.gov/Services/Pages/FileDisclosure.aspx',
        'ws_ag_procedure_identity_policy'      => 'confidential',
        ...
        'ws_ag_procedure_intake_only'          => true,
        'ws_ag_procedure_deadline_days'        => 0,
        'ws_ag_procedure_deadline_clock_start' => '',
        'ws_ag_procedure_has_prerequisites'        => false,
        'ws_ag_procedure_prerequisites_details'   => '',
...
<li><strong>Understand the limits of this pathway.</strong> An OSC wrongdoing disclosure does not produce individual remedies, monetary relief, or direct enforcement action by OSC. If you experienced retaliation for disclosing wrongdoing, file a separate prohibited personnel practice complaint — this disclosure pathway does not protect you from retaliation on its own.</li>
    ...
    [
        ...
        'ws_ag_procedure_entry_point' => 'online',
        'ws_ag_procedure_intake_url'  => 'https://osc.gov/Services/Pages/FileComplaint.aspx',
        'ws_ag_procedure_identity_policy'      => 'confidential',
        'ws_ag_procedure_intake_only'          => false,
...
<li><strong>After OSC&#8217;s determination.</strong> If OSC declines to pursue your complaint, it will issue a written determination. You then have 65 days from that determination to file an IRA appeal at the MSPB. Track this deadline precisely — missing it forfeits your right to independent adjudication.</li>
    ...
    [
        ...
        'disclosure_types'    => [ 'retaliation-protection' ],
        'ws_ag_procedure_entry_point' => 'online',
        'ws_ag_procedure_intake_url'  => 'https://e-appeal.mspb.gov/',
        'ws_ag_procedure_identity_policy'      => 'identified',
        'ws_ag_procedure_intake_only'          => false,
...
<li><strong>Initial Decision and further appeal.</strong> After the hearing, the AJ issues an Initial Decision. Either party may petition the full MSPB Board for review within 35 days. After the Board&#8217;s final decision, you may petition the U.S. Court of Appeals for the Federal Circuit for judicial review.</li>
    ...
    [
        ...
        'ws_ag_procedure_type'        => 'both',
        'disclosure_types'    => [ 'retaliation-protection', 'collective-bargaining' ],
        'ws_ag_procedure_entry_point' => 'online',
        'ws_ag_procedure_intake_url'  => 'https://www.nlrb.gov/reports/nlrb-case-activity-statistics/case-filings/file-a-case',
        'ws_ag_procedure_identity_policy'      => 'identified',
        'ws_ag_procedure_intake_only'          => false,
        'ws_ag_procedure_deadline_days'        => 180,
        'ws_ag_procedure_deadline_clock_start' => 'adverse_action',
        'ws_ag_procedure_has_prerequisites'        => false,
        'ws_ag_procedure_prerequisites_details'   => '',
...
<li><strong>If a complaint is issued.</strong> The case proceeds to a hearing before an NLRB Administrative Law Judge. Remedies for retaliation may include reinstatement, back pay, and a notice posting. The Board&#8217;s order is enforced by the applicable U.S. Court of Appeals.</li>
        ...
        'ws_ag_procedure_exclusivity_details'     => 'Filing an ULP charge with the NLRB does not preclude filing claims under other federal statutes (e.g., SOX, FCA). However, remedies for the same underlying harm may overlap; consult an attorney to coordinate parallel claims and avoid double recovery arguments.',
    ],
    ...
    [
        ...
        'disclosure_types'    => [ 'securities-commodities-fraud' ],
        'ws_ag_procedure_entry_point' => 'online',
        'ws_ag_procedure_intake_url'  => 'https://www.whistleblower.gov/tipsubmission',
...
<li><strong>Award determination.</strong> If CFTC sanctions exceed $1 million and CFTC finds your tip contributed, you may receive 10–30% of collected sanctions. Award determinations may take years after the enforcement action closes.</li>
    ...
    [
        ...
        'ws_ag_procedure_entry_point' => 'mail',
        'ws_ag_procedure_intake_url'  => 'https://www.irs.gov/pub/irs-pdf/f211.pdf',
        'ws_ag_procedure_identity_policy'      => 'confidential',
        'ws_ag_procedure_intake_only'          => false,
        'ws_ag_procedure_deadline_days'        => 0,
        'ws_ag_procedure_deadline_clock_start' => '',
...
<li><strong>Award determination after collection.</strong> If the IRS collects additional taxes, penalties, and interest substantially based on your information, you will receive a preliminary award determination letter. You may contest the award amount by filing a petition in U.S. Tax Court within 30 days of the determination letter.</li>
        ...
        'ws_ag_procedure_exclusivity_details'     => 'The IRS Whistleblower program does not provide anti-retaliation protection. If you experience retaliation for reporting tax fraud, your civil remedy is a separate lawsuit in federal district court under IRC § 7623(d), which must be filed within 180 days of the adverse action.',
    ],
...
<li><strong>Federal court option after OSHA inaction.</strong> Under several environmental statutes, if OSHA has not issued a final order within 30 days of the complaint, you may file a new civil action in federal district court. Consult an attorney about the timing and forum selection for your specific statute.</li>
    ...
    [
        ...
        'ws_ag_procedure_entry_point' => 'mail',
        'ws_ag_procedure_intake_url'  => 'https://www.justice.gov/civil/fraud-section/contact-fraud-section',
        'ws_ag_procedure_identity_policy'      => 'identified',
        'ws_ag_procedure_intake_only'          => false,
        ...
        'ws_ag_procedure_deadline_clock_start' => '',
        'ws_ag_procedure_has_prerequisites'        => true,
        'ws_ag_procedure_prerequisites_details'   => 'You must retain an attorney before filing — the False Claims Act does not permit pro se qui tam relators. The complaint must be filed in federal district court under seal (not served on the defendant) and served simultaneously on the U.S. Department of Justice through the U.S. Attorney\'s Office for the filing district. Your attorney will also prepare a written disclosure statement containing all supporting information about the fraud.',
...
function ws_seed_procedure_matrix() {
    ...
    foreach ( $_ws_procedure_matrix as $proc ) {
        ...
        $meta = [
            'ws_ag_procedure_agency_id'               => $agency_id,
            'ws_ag_procedure_entry_point'             => $proc['ws_ag_procedure_entry_point'],
            'ws_ag_procedure_intake_url'              => $proc['ws_ag_procedure_intake_url'],
            'ws_ag_procedure_identity_policy'         => $proc['ws_ag_procedure_identity_policy'],
            'ws_ag_procedure_intake_only'             => $proc['ws_ag_procedure_intake_only'] ? 1 : 0,
            'ws_ag_procedure_deadline_days'           => (int) $proc['ws_ag_procedure_deadline_days'],
            'ws_ag_procedure_deadline_clock_start'    => $proc['ws_ag_procedure_deadline_clock_start'] ?? '',
            'ws_ag_procedure_has_prerequisites'           => $proc['ws_ag_procedure_has_prerequisites'] ? 1 : 0,
            'ws_ag_procedure_prerequisites_details'      => $proc['ws_ag_procedure_prerequisites_details'] ?? '',
            'ws_ag_procedure_walkthrough_wysiwyg'             => $proc['ws_ag_procedure_walkthrough_wysiwyg'] ?? '',
            'ws_ag_procedure_exclusivity_details'        => $proc['ws_ag_procedure_exclusivity_details'] ?? '',
        ];
        ...
        // ws_procedure_type replaces the former ws_ag_procedure_type meta key.
        // Single-value taxonomy — wp_set_object_terms with append=false
        // ensures exactly one term is assigned per record.

        if ( ! empty( $proc['ws_ag_procedure_type'] ) ) {
            wp_set_object_terms( $post_id, $proc['ws_ag_procedure_type'], 'ws_procedure_type', false );
        }
        ...
        if ( ! empty( $proc['statute_slugs'] ) ) {
            ...
            if ( ! empty( $statute_ids ) ) {
                update_post_meta( $post_id, 'ws_ag_procedure_statute_ids', $statute_ids );
                ...
                foreach ( $statute_ids as $sid ) {
                    delete_transient( 'ws_statute_procedures_' . $sid );
                }
            }
        }
        ...
        update_post_meta( $post_id, 'ws_matrix_source', 'matrix-ag-procedures' );
    }
}
